...
// --- JOBS ---
const JOBS = [
    { title: "Part-time Cashier", salary: 1500000, minSmarts: 0, minAge: 16, type: "Part-time" },
...
// --- ROYALTY TITLES ---
const ROYALTY = [
    { title: "Baron/Baroness", chance: 0.5 },
    { title: "Count/Countess", chance: 0.3 },
    { title: "Duke/Duchess", chance: 0.2 },
    { title: "Marquess/Marchioness", chance: 0.15 },
    { title: "Prince/Princess", chance: 0.15 },
    { title: "King/Queen", chance: 0.1 }
];
...
const RANDOM_EVENTS = [
    ...
    { text: "You read a difficult book.", effect: (p)=>{p.smarts+=5;} },
    { text: "You won a small lottery prize!", effect: (p)=>{p.bank+=10000000;} },
    ...
    { text: "You met someone from a royal family at an event.", effect: (p)=>{if(Math.random()<0.01){p.isRoyal=true; p.bank+=10000000;}} },
